...
public class Speedometer extends View implements SpeedChangeListener {
	...
	public Speedometer(Context context){
		super(context);
		//Log.dTAG,"Speedometer(Context) called");
	...
	public Speedometer(Context context, AttributeSet attrs) {
		super(context, attrs);
		//Log.dTAG,"Speedometer(Context, AttributeSet) called");
	...
	protected void onSizeChanged(int width, int height, int oldw, int oldh) {
		//Log.dTAG, "Size changed to " + width + "x" + height);
...
//		//Log.dTAG, "Width spec: " + MeasureSpec.toString(widthMeasureSpec));
//		//Log.dTAG, "Height spec: " + MeasureSpec.toString(heightMeasureSpec));
