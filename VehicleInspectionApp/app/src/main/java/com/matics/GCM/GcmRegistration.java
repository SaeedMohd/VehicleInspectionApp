...
//            HttpClient client = new DefaultHttpClient();
            ...
            String httpString = String.format(GCM_URL, regid,LivePhoneReadings.getMobileUserProfileId(), LivePhoneReadings.getPhoneId());

//            //Log.i("http String",""+httpString);
//            HttpGet method = new HttpGet(httpString);
...
//                //Log.i("result string", "result string is: "+result);
//
//
//            } catch (Exception e) {
...
//            }
            ...
            //Log.dMainActivity.TAG, "result string is: "+Utility.httpGet(httpString));
