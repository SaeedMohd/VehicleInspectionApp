...
class PDFDataModel {
    ...
    companion object {
        ...
        @Volatile
        private var INSTANCE: PDFDataModel? = null

        fun getInstance(): PDFDataModel =
                INSTANCE ?: synchronized(this) {
                    INSTANCE ?: PDFDataModel().also { INSTANCE = it }
                }

        fun setInstance(facilityDataModel: PDFDataModel){
